...
export const updateReport =
  ...
  async (dispatch) => {
    ...
    const req = await axios.patch(`${process.env.REACT_APP_API_URL}/api/v1/reports/updateReport`, body, config)
  }
...
export const updateInstances =
  ...
  async (dispatch) => {
    ...
    try {
      const req = await axios.patch(`${process.env.REACT_APP_API_URL}/api/v1/reports/updateReportInstances`, body, config)
    } catch (err) {}
  }
