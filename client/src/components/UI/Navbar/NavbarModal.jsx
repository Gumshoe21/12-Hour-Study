      ...
      <form visibility='hidden' onSubmit={(e) => onSubmit(e)}>
        <FormControl>
          ...
          >
            <ModalOverlay />
            <ModalContent>
              <ModalHeader textTransform='uppercase' fontSize='1.4rem'>
                Timer Settings
              </ModalHeader>
              ...
              <ModalBody>
                <Flex flexDirection='column'>
                  <Flex justifyContent='center' alignItems='center' flexDirection='column' rowGap={4}>
                    <NavbarModalInput ref={sessionRef} name={'session'} label={'Session'} defaultValue={timer.modes['session'].length} />
                    <NavbarModalInput ref={shortBreakRef} name={'shortBreak'} label={'Short Break'} defaultValue={timer.modes['shortBreak'].length} />
                    <NavbarModalInput ref={longBreakRef} name={'longBreak'} label={'Long Break'} defaultValue={timer.modes['longBreak'].length} />
                    <NavbarModalInput ref={longBreakIntRef} name={'longBreakInterval'} label={'Long Break Interval'} defaultValue={timer.longBreakInterval} />
                    <Flex mt='.8rem' w='100%' align='center' justify='space-between'>
                      <FormLabel fontSize='1.4rem' htmlFor='tickingSoundMuted'>
                        Mute Ticking Sound
                      </FormLabel>
                      <Switch
                    ...
                    <Flex mt='.8rem' w='100%' align='center' justify='space-between'>
                      <FormLabel fontSize='1.4rem' htmlFor='tickingSoundVolume'>
                      ...
                      >
                        <SliderMark value={0.0}>0%</SliderMark>

                        <SliderMark value={1.0}>100%</SliderMark>

                        <SliderMark value={timer.tickingSoundVolume} textAlign='center' bg='primary.500' color='white' mt='-10' ml='-5' w='12'>
